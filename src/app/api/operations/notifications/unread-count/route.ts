/**
 * ============================================================================
 * Splinci Commerce OS — Unread Notifications Count REST API
 * ============================================================================
 * Specification Reference: M12-003 / API-001 / IAM-002
 * Route: GET /api/operations/notifications/unread-count
 * ============================================================================
 */
...
export async function GET(req: NextRequest) {
  try {
    ...
    const count = await operationsService.notifications.getUnreadCount(
      session.companyId,
      session.userId
    );
