/**
 * ============================================================================
 * Atlas Commerce OS — Accounts Receivable Aging REST API Handler
 * ============================================================================
...
export async function GET(req: NextRequest) {
  try {
    ...
    const agingReport = await receivablesService.getAgingReport(session.companyId);

    return NextResponse.json({ success: true, data: agingReport });
  } catch (error: any) {
