/**
 * ============================================================================
 * Atlas Commerce OS — Credit Note REST API Handler
 * ============================================================================
 * Specification Reference: FIN-004 / API-001 / IAM-002
 * Route: GET /api/finance/credit-notes, POST /api/finance/credit-notes
 * ============================================================================
 */
...
import { creditNoteService } from "@/services/finance/credit-note.service";
import { CreateCreditNoteSchema } from "@/types/finance.dto";
...
export async function GET(req: NextRequest) {
  try {
    ...
    const result = await creditNoteRepository.findMany(session.companyId, page, limit);
...
export async function POST(req: NextRequest) {
  try {
    ...
    const creditNote = await creditNoteService.createCreditNote(session, parsed.data);
