/**
 * ============================================================================
 * Atlas Commerce OS — Workflow Version Publish REST API Endpoint
 * ============================================================================
 * Specification Reference: M11-003 / API-001 / IAM-002
 * Route: POST /api/workflows/:id/versions/publish
 * ============================================================================
 */
...
export async function POST(
  ...
  try {
    ...
    const published = await workflowService.workflow.publishVersion(
      session.companyId,
      id,
      versionNumber,
      session.userId
