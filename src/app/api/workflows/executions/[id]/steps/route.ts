/**
 * ============================================================================
 * Atlas Commerce OS — Execution Step Update REST API Endpoint
 * ============================================================================
 * Specification Reference: M11-003 / API-001 / IAM-002
 * Route: POST /api/workflows/executions/:id/steps
 * ============================================================================
 */
...
import { UpdateExecutionStepSchema } from "../../../../../../types/workflow.dto";
...
export async function POST(
  ...
  try {
    ...
    const updated = await workflowService.execution.executeStep(
      session.companyId,
      id,
      parsed.data
    );
