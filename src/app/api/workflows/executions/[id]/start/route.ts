/**
 * ============================================================================
 * Atlas Commerce OS — Execution Start REST API Endpoint
 * ============================================================================
 * Specification Reference: M11-003 / API-001 / IAM-002
 * Route: POST /api/workflows/executions/:id/start
 * ============================================================================
 */
...
export async function POST(
  ...
  try {
    ...
    const started = await workflowService.execution.startExecution(
      session.companyId,
      id,
      session.userId
    );
