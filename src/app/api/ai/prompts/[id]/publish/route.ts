/**
 * ============================================================================
 * Ondrio Commerce OS — AI Prompt Publish REST API Endpoint Handler
 * ============================================================================
 * Specification Reference: M9-003 / API-001 / IAM-002
 * Route: POST /api/ai/prompts/[id]/publish
...
export async function POST(
  ...
  try {
    ...
    const template = await aiService.prompt.publishTemplate(
      session.companyId,
      session.userId,
      resolvedParams.id
    );
