/**
 * ============================================================================
 * Ondrio Commerce OS — AI Enrichment Approval REST API Endpoint Handler
 * ============================================================================
 * Specification Reference: M9-003 / API-001 / IAM-002
 * Route: POST /api/ai/enrichment/[id]/approve
...
export async function POST(
  ...
  try {
    ...
    const result = await aiService.enrichment.approveEnrichment(
      session.companyId,
      session.userId,
      resolvedParams.id
    );
